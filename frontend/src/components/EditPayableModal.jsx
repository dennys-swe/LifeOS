      ...
      <div className="my-auto w-full max-w-xl rounded-2xl border border-slate-200/80 bg-white/95 shadow-2xl backdrop-blur-xl dark:border-slate-800/80 dark:bg-slate-900/95">
        <div className="p-6">
          <div className="flex items-start justify-between gap-3">
            <div>
              <p className="font-display text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-slate-500">Conta a pagar</p>
              <h2 className="mt-1 font-display text-xl font-bold tracking-tight text-slate-900 dark:text-white">Editar conta</h2>
            </div>
            <button
              type="button"
              onClick={onClose}
          ...
          <form onSubmit={handleSubmit} className="mt-6 flex flex-col gap-4">
            ...
            <div className="border-t border-slate-100 pt-2 dark:border-slate-800">
              <p className="mb-2 text-xs font-medium text-slate-400 dark:text-slate-500">Repetir todo mês automaticamente</p>
              <button
                type="button"
